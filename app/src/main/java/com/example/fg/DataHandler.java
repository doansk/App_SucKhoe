...
public class DataHandler extends SQLiteOpenHelper  {
    ...
    private static final String DATABASE_NAME = "Banghichu.db";
    public static final String TABLE_NAME = "Ghichu";
    public static final String COLUMN_ID = "ten";
    public static final String COLUMN_NAME = "noidung";
    ...
    public void addDataHandler(BangGhiChu student) {
    ...
    public boolean deleteDataHandler(String ID) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(query, null);
        BangGhiChu student = new BangGhiChu();
    ...
    public List<BangGhiChu> findAllDataHandler(String studentname) {
        ...
        List<BangGhiChu> lst =  new ArrayList<BangGhiChu>();
